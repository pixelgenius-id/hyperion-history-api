...
export function addSharedSchemas(fastify: FastifyInstance) {
    ...
    fastify.addSchema({
        $id: "Signature",
        type: "string",
        description: "String representation of an VEXANIUM compatible cryptographic signature",
    ...
    fastify.addSchema({
        $id: "AccountName",
        description: "String representation of an VEXANIUM compatible account name",
        anyOf: [
            {
                "type": "string",
                "description": "String representation of privileged VEXANIUM name type",
                "pattern": "^(vex[\\.][a-z1-5]{1,6})([a-j]{1})?$",
                "title": "NamePrivileged"
            },
            {
                "type": "string",
                "description": "String representation of basic VEXANIUM name type, must be 12 characters and contain only a-z and 0-5",
                "pattern": "^([a-z]{1}[a-z1-5]{11})([a-j]{1})?$",
                "title": "NameBasic"
            },
            {
                "type": "string",
                "description": "String representation of VEXANIUM bid name type, 1-12 characters and only a-z and 0-5 are allowed",
                "pattern": "^([a-z1-5]{1,12})([a-j]{1})?$",
                "title": "NameBid"
            },
            {
                "type": "string",
                "description": "String representation of VEXANIUM name type",
