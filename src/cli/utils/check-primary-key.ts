...
//     // console.log(await findAndValidatePrimaryKey("vex.token", "accounts"));
//     // console.log(await findAndValidatePrimaryKey("vex.msig", "proposal"));
//     console.log(await findAndValidatePrimaryKey("vexcore", "producers"));
// })();
